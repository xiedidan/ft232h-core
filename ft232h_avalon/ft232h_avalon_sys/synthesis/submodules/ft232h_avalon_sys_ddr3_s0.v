...
`timescale 1 ps / 1 ps
module ft232h_avalon_sys_ddr3_s0 (
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (23552),
		.INIT_FILE        ("ft232h_avalon_sys_ddr3_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	ft232h_avalon_sys_ddr3_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	ft232h_avalon_sys_ddr3_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
