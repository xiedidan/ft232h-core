...
# Memory: dma_ram
MEM_0 := ft232h_avalon_sys_dma_ram
$(MEM_0)_NAME := dma_ram
...
$(MEM_0)_HIERARCHICAL_PATH := dma_ram
$(MEM_0)_WIDTH := 32
...
.PHONY: dma_ram
dma_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: ram
MEM_1 := ft232h_avalon_sys_ram
$(MEM_1)_NAME := ram
