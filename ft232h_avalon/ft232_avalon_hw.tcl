...
# Mon Dec 05 20:41:17 CST 2016
# DO NOT MODIFY


# 
# ft232_avalon "ft232_avalon" v1.0
#  2016.12.05.20:41:17
# 
# 
...
set_module_property NAME ft232_avalon
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME ft232_avalon
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL ft232h_avalon
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file ft232h_avalon.v VERILOG PATH ft232h_avalon/ft232h_avalon.v TOP_LEVEL_FILE


# 
# parameters
# 
add_parameter READ_DATA INTEGER 0
set_parameter_property READ_DATA DEFAULT_VALUE 0
set_parameter_property READ_DATA DISPLAY_NAME READ_DATA
set_parameter_property READ_DATA TYPE INTEGER
set_parameter_property READ_DATA UNITS None
set_parameter_property READ_DATA HDL_PARAMETER true
add_parameter WRITE_DATA INTEGER 1
set_parameter_property WRITE_DATA DEFAULT_VALUE 1
set_parameter_property WRITE_DATA DISPLAY_NAME WRITE_DATA
set_parameter_property WRITE_DATA TYPE INTEGER
set_parameter_property WRITE_DATA UNITS None
set_parameter_property WRITE_DATA HDL_PARAMETER true
add_parameter RX_FIFO_COUNTER INTEGER 2
set_parameter_property RX_FIFO_COUNTER DEFAULT_VALUE 2
set_parameter_property RX_FIFO_COUNTER DISPLAY_NAME RX_FIFO_COUNTER
set_parameter_property RX_FIFO_COUNTER TYPE INTEGER
set_parameter_property RX_FIFO_COUNTER UNITS None
set_parameter_property RX_FIFO_COUNTER HDL_PARAMETER true
add_parameter TX_FIFO_COUNTER INTEGER 3
set_parameter_property TX_FIFO_COUNTER DEFAULT_VALUE 3
set_parameter_property TX_FIFO_COUNTER DISPLAY_NAME TX_FIFO_COUNTER
set_parameter_property TX_FIFO_COUNTER TYPE INTEGER
set_parameter_property TX_FIFO_COUNTER UNITS None
set_parameter_property TX_FIFO_COUNTER HDL_PARAMETER true
add_parameter RX_ALMOST_FULL_THRESHOLD INTEGER 4
set_parameter_property RX_ALMOST_FULL_THRESHOLD DEFAULT_VALUE 4
set_parameter_property RX_ALMOST_FULL_THRESHOLD DISPLAY_NAME RX_ALMOST_FULL_THRESHOLD
set_parameter_property RX_ALMOST_FULL_THRESHOLD TYPE INTEGER
set_parameter_property RX_ALMOST_FULL_THRESHOLD UNITS None
set_parameter_property RX_ALMOST_FULL_THRESHOLD HDL_PARAMETER true
add_parameter TX_ALMOST_EMPTY_THRESHOLD INTEGER 5
set_parameter_property TX_ALMOST_EMPTY_THRESHOLD DEFAULT_VALUE 5
set_parameter_property TX_ALMOST_EMPTY_THRESHOLD DISPLAY_NAME TX_ALMOST_EMPTY_THRESHOLD
set_parameter_property TX_ALMOST_EMPTY_THRESHOLD TYPE INTEGER
set_parameter_property TX_ALMOST_EMPTY_THRESHOLD UNITS None
set_parameter_property TX_ALMOST_EMPTY_THRESHOLD HDL_PARAMETER true
add_parameter CLEAR_IRQ INTEGER 6
set_parameter_property CLEAR_IRQ DEFAULT_VALUE 6
set_parameter_property CLEAR_IRQ DISPLAY_NAME CLEAR_IRQ
set_parameter_property CLEAR_IRQ TYPE INTEGER
set_parameter_property CLEAR_IRQ UNITS None
set_parameter_property CLEAR_IRQ HDL_PARAMETER true
add_parameter CONTROL INTEGER 7
set_parameter_property CONTROL DEFAULT_VALUE 7
set_parameter_property CONTROL DISPLAY_NAME CONTROL
set_parameter_property CONTROL TYPE INTEGER
set_parameter_property CONTROL UNITS None
...
set_interface_property usb associatedReset reset
...
set_interface_property tx_irq associatedReset reset
